CREATE OR REPLACE PROCEDURE SP_LOAN_ALGORITHM_3(P_LOAN_AMNT NUMBER,
  ...
  --LN_SUP_PER      TRANSACTION_SUMMARY.SUP_PER%TYPE;
  --LN_OWNER_PER    TRANSACTION_SUMMARY.OWNER_PER%TYPE;
  --LN_INV_PER      TRANSACTION_SUMMARY.INV_PER%TYPE;
  ...
  IF SF_GET_LOAN_STATUS(P_LOAN_AMNT, P_COMD_NAME) THEN
    ...
    FOR I IN CUR_INV_DATA LOOP
      IF LN_LOAN_AMNT > I.AVBL_AMNT THEN
        ...
        /* DBMS_OUTPUT.PUT_LINE('greater than--> I.INV_ID   ' || I.INV_ID ||
                             '   P_LOAN_AMNT  ' || P_LOAN_AMNT ||
                             '   I.SUP_ID   ' || I.SUP_ID ||
                             '    INV_TRA_PAR_PER   ' ||
                             TRUNC(I.AVBL_AMNT / P_LOAN_AMNT * 100) ||
                             '   I.AVBL_AMNT   ' || I.AVBL_AMNT);
      ...
      ELSIF LN_LOAN_AMNT = I.AVBL_AMNT THEN
        ...
        /* DBMS_OUTPUT.PUT_LINE('equal to--> I.INV_ID   ' || I.INV_ID ||
                             '   P_LOAN_AMNT  ' || P_LOAN_AMNT ||
                             '   I.SUP_ID   ' || I.SUP_ID ||
                             '    INV_TRA_PAR_PER   ' ||
                             TRUNC(LN_LOAN_AMNT / P_LOAN_AMNT * 100) ||
                             '   I.AVBL_AMNT   ' || I.AVBL_AMNT);
      ...
      ELSIF LN_LOAN_AMNT < I.AVBL_AMNT AND I.FRACTION = 'Y' THEN
        ...
        /*DBMS_OUTPUT.PUT_LINE('less than --> I.INV_ID   ' || I.INV_ID ||
                             '   P_LOAN_AMNT  ' || P_LOAN_AMNT ||
                             '   I.SUP_ID   ' || I.SUP_ID ||
                             '    INV_TRA_PAR_PER   ' ||
                             TRUNC(LN_LOAN_AMNT / P_LOAN_AMNT * 100) ||
                             '   I.AVBL_AMNT   ' || I.AVBL_AMNT ||
                             '  INV_PAR_PER  ' ||
                             TRUNC(LN_LOAN_AMNT / I.AVBL_AMNT * 100));
